<h2 align="center"> Hey 🙋‍♂️, I'm Jhass Theisen </h2> <h3 align="center"> A Power Platform Developer from California </h3> <p align="center"> <img width=100% src="https://github.com/jhatheisen/jhatheisen/assets/106848904/6f37162f-1062-4a22-9bf7-df4340b3f957"> </p>

I'm a Power Platform Developer specializing in creating scalable, low-code business solutions using Microsoft’s ecosystem. I design and automate workflows, build responsive apps, and create interactive dashboards that empower teams to make data-driven decisions.

I’m experienced in Power Apps (Canvas and Model-Driven), Power Automate, Power BI, and SharePoint, with a strong foundation in SQL, Dataverse, and Azure integration. My background as a full-stack developer allows me to extend Power Platform solutions with custom connectors, APIs, and scripts when needed.

Currently developing Organize Bonanza, a Power Apps and Power Automate–driven inventory management system for retail companies — designed to streamline product tracking, order fulfillment, and approval workflows.

💼 Open to Power Platform, Dynamics 365, or Microsoft 365 Developer roles.
...
⚡ Automate workflows with Power Automate and Microsoft 365 connectors

📊 Build Power BI dashboards integrating data from SQL, SharePoint, and Dataverse

🔗 Integrate Power Platform with custom APIs, Azure Functions, and legacy systems

🧱 Extend Microsoft solutions using JavaScript, Power Fx, and Python scripting
